...
import { Injected, InjectedWeb3, PrivateWalletStateInfo } from '../components/interfaces';
...
export default function Sbtmint() {
  ...
  const [isInjected] = useState(true);
  ...
  return (
    <div className="App">
      {!isInjected ? (
        ...
        color="primary"
        onClick={onConnect}
        className="mt-4 px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-opacity-50"
        >
          Connect
        </Button>
      ) : (
